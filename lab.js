...
//CODE HERE
var amys = (`Amy`)
var brittani = (`Brittani`)
if ( amysAge < brittanisAge) {
  console.log(`${brittani} is older.`)
} else if (amysAge > brittanisAge) {
  console.log(`${amys} is older.`)
} else {
  console.log (`${brittanisAge} and ${amysAge} are the same age.`)
}
////////// PROBLEM 3 //////////
...
if (temp >= 80 + rain) {
 ...
 else if (temp >60 &&  80 + rain){
  console.log ('One should wear a rain jacket')
 }
  else (temp <= 60 + rain); {
    console.log('Should carry a jacket and umbrealla')
  }
...
console.log (changeMyMind === true); //true
console.log (changeMyMind === false); //false
////////// PROBLEM 10 //////////
